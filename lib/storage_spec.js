...
// Test simple_storage
var couchdbStorage = require("./storage")("http://localhost:5984/botkit");

testStorageMethod(couchdbStorage.users);
testStorageMethod(couchdbStorage.channels);
testStorageMethod(couchdbStorage.teams);
